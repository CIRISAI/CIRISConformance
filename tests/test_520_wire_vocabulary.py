...
# HTTPS-only: `disable_reticulum=True` requires an https_listen_addr in
# exchange (an edge with no transports at all is refused). Which transport is
# up does not change what is under test.
