...
| CC 6.1.2 aggregation dominance / N_eff gate (900/1000) | CCS | ⏳ | `tests/noise_floor.rs::dominance_undetectable_pending_ciris_verify_167` (**runs**, pins the gap: a dominated fold N_eff≈1.2 HybridVerifies byte-identically to a balanced N_eff=10) → **CIRISVerify#167** / **CIRISConstitution#6** |
