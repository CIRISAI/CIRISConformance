...
| `test_240_reserved_prefix_admission.py` | fabric | Namespace admission: non-member cannot write a family cohort scope; CC 3.4 reserved prefixes ⏳ [persist#288](https://github.com/CIRISAI/CIRISPersist/issues/288) | ✅ |
